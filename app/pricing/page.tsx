      ...
      <div className="max-w-4xl w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border border-zinc-800 rounded-2xl p-6 flex flex-col items-center bg-zinc-900">
            ...
            <p className="text-3xl font-bold mb-2">$0<span className="text-base font-normal text-zinc-400">/month</span></p>
            <p className="text-zinc-400 mb-4">Basic</p>
            <ul className="text-zinc-300 text-sm mb-6 space-y-2 text-left w-full max-w-xs mx-auto">
              <li>✅ Link 1 account</li>
              <li>✅ View other users' portfolios</li>
          ...
          {/* Pro (Legend) Plan */}
          <div className="border border-zinc-800 rounded-2xl p-6 flex flex-col items-center bg-zinc-900">
            <h2 className="text-2xl font-semibold mb-2">Pro <span className="text-sm text-purple-400">(Legend)</span></h2>
            <p className="text-3xl font-bold mb-2">$10<span className="text-base font-normal text-zinc-400">/month</span></p>
